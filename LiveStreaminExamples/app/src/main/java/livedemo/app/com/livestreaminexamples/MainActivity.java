package livedemo.app.com.livestreaminexamples;
...
import livedemo.app.com.livestreaminexamples.streaming.rtsp.RtspClient;
...
OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT >= 23) {
			if (!checkPermission()) {
				ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA,Manifest.permission.RECORD_AUDIO,Manifest.permission.MEDIA_CONTENT_CONTROL}, PERMISSION_REQUEST_CODE);
			}
		}
